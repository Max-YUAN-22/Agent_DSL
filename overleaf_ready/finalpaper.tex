...
\begin{table}[htbp]
\caption{Performance Comparison with Real Measurements}
...
\textbf{Our DSL} & \textbf{5.08} & \textbf{61.74} & \textbf{176.9} & \textbf{100\%} \\
\bottomrule
\end{tabular}%
}
\end{table}
...
% Ablation study results would be included here
% Tables and figures are embedded directly in the main text
